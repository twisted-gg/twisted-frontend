        ...
        step_3: (
          <Form className='form-horizontal'>
            ...
            <div className='wizard-actions d-flex justify-content-between'>
              ...
              <Button color='primary' onClick={() => window.alert('Form Submitted')}>
                Submit
              </Button>
            </div>
          </Form>
      ...
      <Card>
        ...
        <CardBody>
          <Wizard
            ...
            stepsTitle={[
              <Home size={20} key='wizardMenyHome' />,
              <Briefcase size={20} key='wizardMenyBriefcase' />,
              <Image size={20} key='wizardMenyImage' />
            ]}
